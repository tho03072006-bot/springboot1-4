...
<div class="credential-hint"><strong>Tài khoản demo:</strong> <code><c:out value="${demoUsername}"/></code> / <code><c:out value="${demoPassword}"/></code></div>
...
<label class="form-label" for="password">Mật khẩu</label><div class="password-field"><input id="password" type="password" name="password" class="form-control" required autocomplete="current-password"><button type="button" class="password-toggle" data-toggle-for="password">Hiện</button></div><button class="btn btn-primary">Đăng nhập</button></form></main></div>
</body></html>
